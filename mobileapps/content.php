<div class="b-layout b-layout__page b-promo">
            ...
            <table class="b-layout__table b-layout__table_width_full b-layout__table_margtop_10 b-layout__table_margbot_40">
                <tbody><tr class="b-layout__tr">
                    ...
                    <td class="b-layout__td b-layout__td_center"><div class="b-shadow b-shadow_inline-block"><img src="/images/apps/12.png" class="b-pic"></div></td>
                    <td class="b-layout__td b-layout__td_center"><div class="b-shadow b-shadow_inline-block"><img src="/images/apps/13.png" class="b-pic"></div></td>
                    <td class="b-layout__td b-layout__td_center"><div class="b-shadow b-shadow_inline-block"><img src="/images/apps/14.png" class="b-pic"></div></td>
                    <td class="b-layout__td b-layout__td_center"><div class="b-shadow b-shadow_inline-block"><img src="/images/apps/15.png" class="b-pic"></div></td>
                </tr>
                </tbody></table>
            <div class="b-promo__wave b-promo__wave_padbot_30"></div>
            <h2 class="b-txt__title b-txt__title_center">Android</h2>
            ...
            <table class="b-layout__table b-layout__table_width_full b-layout__table_margtop_10 b-layout__table_margbot_40">
                <tbody><tr class="b-layout__tr">
                    ...
                    <td class="b-layout__td b-layout__td_center"><div class="b-shadow b-shadow_inline-block"><img src="/images/apps/22.png" class="b-pic"></div></td>
                    <td class="b-layout__td b-layout__td_center"><div class="b-shadow b-shadow_inline-block"><img src="/images/apps/23.png" class="b-pic"></div></td>
                    <td class="b-layout__td b-layout__td_center"><div class="b-shadow b-shadow_inline-block"><img src="/images/apps/24.png" class="b-pic"></div></td>
                    <td class="b-layout__td b-layout__td_center"><div class="b-shadow b-shadow_inline-block"><img src="/images/apps/25.png" class="b-pic"></div></td>
                </tr>
                </tbody></table>
