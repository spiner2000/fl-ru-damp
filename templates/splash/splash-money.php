<div class="i-shadow i-shadow_zindex_110" id="splash-money">
    <div class="b-shadow b-shadow_inline-block b-shadow_width_560 b-shadow_vertical-center" >
        ...
        <span class="b-shadow__icon b-shadow__icon_close" onclick="$('money-overlay').dispose()"></span>
    </div>
</div>

<div class="b-shadow__overlay b-shadow__overlay_bg_black" id="money-overlay"></div>
