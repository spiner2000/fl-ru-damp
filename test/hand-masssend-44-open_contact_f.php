...
<table style="margin-top: 0pt; margin-left: auto; margin-right: auto; background-color: #ffffff;" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="740">
    ...
    <tr>
        ...
        <td class="pad_null" bgcolor="#ffffff">
            <font color="#4d4d4d" size="1" face="tahoma,sans-serif">По всем возникающим вопросам вы можете обращаться в нашу <a target="_blank" style="color:#0f71c8;" href="https://feedback.free-lance.ru?utm_source=newsletter4&utm_medium=email&utm_campaign=open_contacts_free">службу поддержки</a>.<br>
Вы можете отключить уведомления на <a target="_blank" style="color:#0f71c8;" href="<?= $eHost ?>/unsubscribe?ukey=%%%UNSUBSCRIBE_KEY%%%&utm_source=newsletter4&utm_medium=email&utm_campaign=open_contacts_free">этой странице</a>.</font>
        </td>
        <td class="pad_null" bgcolor="#ffffff" width="20"></td>
        <td class="pad_null" bgcolor="#ffffff" width="20"></td>
  </tr>
