<b class="b-fon__b1"></b>
<b class="b-fon__b2"></b>
<div class="qq-upload-wysiwyg" file="">
    <div id="attachedfiles_selectfile_div" class="b-fon__item b-fon__item_first b-fon__item_last">
        <input type="hidden" name="IDResource[]" value="{IDResource}"/>
        <div class="b-file__wrap" id="attachedfiles_file_div">                                   							
            <div class="b-button b-button_margright_5 b-button_rectangle_color_transparent qq-upload-button">
                <span class="b-button__b1">                									
                    <span class="b-button__b2">       
                        <span class="b-button__txt">{uploadButtonText}</span>
                    </span>                    								
                </span>                    							
            </div>                						
        </div>                       
    </div>
    <div class="b-file__txt b-layout__txt_hide b-file__txt_relative b-file__txt_padleft_15 qq-popup-info">
