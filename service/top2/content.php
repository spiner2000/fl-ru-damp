<table class="b-layout__table b-layout__table_width_full">
	...
	<h1 class="b-page__title">Поднятие закрепленного проекта</h1>
	<div class="b-layout__txt b-layout__txt_padbot_20">Для того, чтоб ваш проект стал самым первым в общей ленте и находился выше всех остальных платных проектов (или конкурсов), воспользуйтесь услугой поднятия закрепленного проекта. Так ваше предложение увидят все посетители главной страницы Free-lance.ru.</div>
