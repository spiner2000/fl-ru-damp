...
/**
 * @todo $_GET['subdomain'] сделано для тестирования, скорей всего при разборе URI апачем можно будет писать в эту переменную поддомен 
 */
...
switch($_GET['msgok']) {
    case 1:
        $is_save = true;
        $msgtext = 'Раздел успешно добавлен';
        break;
    case 2:
        $is_save = true;
        $msgtext = 'Раздел успешно изменен';
        break;
    case 3:
        $is_save = true;
        $msgtext = 'Напревление успешно добавлено';
        break;
    case 4:
        $is_save = true;
        $msgtext = 'Направление успешно изменено';
        break;
    case 5:
        $is_save = true;
        $msgtext = 'Подраздел успешно добавлен';
        break;
    case 6:
        $is_save = true;
        $msgtext = 'Подраздел успешно изменен';
        break;
}
