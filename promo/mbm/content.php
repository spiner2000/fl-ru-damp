            <table class="b-layout__table b-layout__table_width_full b-layout__table_margbot_30">
               <tr class="b-layout__tr">
                  ...
                  <td class="b-layout__td b-layout__td_width_33ps">
                     ...
                     <div class="b-layout__txt b-layout__txt_padbot_10 b-layout__txt_fontsize_16"><img class="b-pic" src="<?=WDCPREFIX?>/images/mdm/tel.png" width="18" height="18"> +7(495) 225-14-14</div>
                     <div class="b-layout__txt b-layout__txt_fontsize_16"><img class="b-pic" src="<?=WDCPREFIX?>/images/mdm/mail.png" width="18" height="18"> info@mbm.ru</div>
                     </div>
                  </td>
               </tr>
            </table>
            ...
            <div style=" height:3px; background-color:#f6931e; margin-bottom:30px;"></div>
            <table class="b-layout__table b-layout__table_width_full b-layout__table_margbot_30">
               <tr class="b-layout__tr">
            ...
            <div class="b-anchor" id="a1"></div>
            <div class="b-fon b-fon_padtop_40" style="background-color:#f5921d">
            <table class="b-layout__table b-layout__table_width_full b-layout__table_margbot_30">
               <tr class="b-layout__tr">
            ...
            <style type="text/css">.b-layout__page{ width:898px; margin:0 auto;}</style>