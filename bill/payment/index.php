...
//@todo: Данный раздел /bill/payment/ более не используется
//стоИт вопрос об его удалении
...
if($action == 'payment') {
    ...
    if($payment_sum <=0) { // Если хватает средств полностью оплатить с личного счета
