...
<div class="b-layout b-layout_pad_10 b-layout_bord_e6 b-layout_relative b-layout_margbot_10">
    ...
    <div class="b-layout__txt b-layout__txt_fontsize_15 b-layout__txt_padleft_70 b-layout__txt_padleft_null_iphone b-layout__txt_padtop_2">Профессиональный аккаунт на <?= $type['is_test'] ? '1 неделю' : ($type['month'] . ' ' . ending($type['month'], 'месяц', 'месяца', 'месяцев'))?></div>
</div>