<h2 class="b-shadow__title b-shadow__title_padbot_15">Профессиональный аккаунт на  
    <span class="i-shadow">
...
<div class="b-check">
    ...
    <label for="auto-pro" class="b-check__label b-check__label_fontsize_15">Ежемесячное автопродление аккаунта</label>
    <span class="i-shadow">
        <a class="b-layout__link b-layout__link_inline-block b-layout__link_fontsize_15 b-layout__link_ygol popup-mini-open upd-auto-period-data" href="javascript:void(0)"><?= $last_operation['month']?> <?= ending($last_operation['month'], 'месяц', 'месяца', 'месяцев')?></a>
...
<div class="b-buttons b-buttons_padtop_15">
    <a href="javascript:void(0)" class="b-button b-button_flat b-button_flat_green btn_add_service">Купить за <span class="upd-cost-sum"><?= $last_operation['sum']?></span> руб.</a>
</div>