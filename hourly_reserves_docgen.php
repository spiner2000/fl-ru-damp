 ...
 * 
 * 
 * Крон обнаружения и генерации недостоющий документов 
 * по закрытым резервам заказов (БС).
 * 
 * Это временное решение от проблемы ошибки генерации документов "на лету"
 * Пока генерация небудет перенесена в очередь обработки
 */
