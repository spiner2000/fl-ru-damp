...
<div class="b-form b-form_padbot_20">
    ...
    <div class="b-combo b-combo_inline-block">
        <div class="b-combo__input b-combo__input_width_50">
            <input id="date_e" name="time_s" class="b-combo__input-text" type="text" size="80" placeholder="08:00">
        </div>
    </div>
    ...
    <div class="b-combo b-combo_inline-block">
        <div class="b-combo__input b-combo__input_calendar b-combo__input_width_125 b-combo__input_arrow-date_yes use_past_date no_set_date_on_load">
            <input id="date_e" name="date_e" class="b-combo__input-text" type="text" size="80">
            <span class="b-combo__arrow-date"></span> 
        </div>
    </div>
    <div class="b-combo b-combo_inline-block">
        <div class="b-combo__input b-combo__input_width_50">
            <input id="date_e" name="time_e" class="b-combo__input-text" type="text" size="80" placeholder="17:00">
        </div>
    </div>
