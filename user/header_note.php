          ...
          <form action="">
             <input type="hidden" name="rating" id="note_rating" value="<?= (int)$aNote['rating']?>">
                 ...
                 <div class="b-buttons b-buttons_padtop_10">
                  <a href="javascript:void(0);" onclick="xajax_saveHeaderNote('<?=$name?>',$('header_note').get('value'), $('note_rating').get('value'));" class="b-button b-button_flat b-button_flat_grey">Сохранить</a>
