    ...
    <table cellspacing="0" cellpadding="0" border="0" class="b-layout__table b-layout__table_width_full">
        <tr class="b-layout__tr">
            ...
            <td class="b-layout__right b-layout__right_padright_15 b-layout__right_width_73ps">
                <div class="b-layout__txt b-layout__txt_padbot_20">На номер <span class="b-layout__bold"><?= pskb::phone($lc['numPerf']) ?></span> в течение 5 минут придет код подтверждения. Введите последний полученный код, чтобы завершить <?= $sbr->status == sbr::STATUS_COMPLETED ? 'сделку' : 'этап' ?>.<br>
                    <span class="b-layout__txt b-layout__txt_color_c7271e" id="alert_sms"></span>
                    <span class="b-layout__txt" id="resend_sms"></span>
                    <a class="b-layout__link b-layout__link_bordbot_dot_0f71c8" id="send_sms" href="javascript:void(0)" onclick="xajax_resendCode(<?= $sbr->data['id'] ?>, <?= $stage->data['id']?>)">Выслать код повторно.</a>
                </div>
                ...
                <a href="javascript:void(0)" onclick="_send_code(<?= $sbr->data['id'] ?>)" id="send_btn" class="b-button b-button_flat b-button_flat_green">Подтвердить</a>
